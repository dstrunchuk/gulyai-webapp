...
const Profile = () => {
  ...
  <div className="w-full max-w-md bg-gradient-to-br from-[#2c2c2e] to-[#1f1f20] p-6 rounded-2xl shadow-2xl space-y-4">
    ...
    {!isViewingAnotherProfile ? (
      <>
        {/* Поля редактирования — только для себя */}
        <div className="flex items-start justify-between gap-2">
          <button
            onClick={handleUpdateAddress}
            className="ml-auto px-4 py-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl text-sm font-medium shadow-md hover:opacity-90 transition"
          >
            Обновить
          </button>
        </div>
